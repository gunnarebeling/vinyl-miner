        ...
        <motion.div
            ...
            <div className="header text-center d-flex justify-content-between m-3">
                ...
                <header className=" d-flex align-items-center bodoni-moda-sc-title">
                    ...
                    <span className="text-center">{usersVinyl[0]?.user.fullName}'s Collection </span><span className="ms-3"><button className={followed ? "btn btn-primary" :"btn btn-outline-primary"} onClick={handleFollow}>{followed ? "unfollow" : "follow"}</button></span> 
                </header>}
            </div>
